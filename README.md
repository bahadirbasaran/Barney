...
<figure class="half" style="display:flex">
    <img style="width:400px" src="./resources/datasetGeneration.png">
    <img style="width:600px" src="./resources/dataset_builder.png">
    <figcaption>Dataset Generation</figcaption>
</figure>
